...
declare -a Router_Subnets_list=("SN1" "192.168.$ID.0/27" "SN2" "192.168.$ID.64/27" "SN3" "192.168.$ID.96/27" "SN4" "192.168.$ID.128/27")
declare -a Server_Subnets_list=("SN1" "172.17.$ID.0/27" "SN2" "172.17.$ID.64/27" "SN3" "172.17.$ID.96/27" "SN4" "172.17.$ID.128/27")

declare -a Router_Subnet_addresses=("192.168.$ID.0/27" "192.168.$ID.64/27" "192.168.$ID.96/27" "192.168.$ID.128/27")
declare -a Server_Subnet_addresses=("172.17.$ID.0/27" "172.17.$ID.64/27" "172.17.$ID.96/27" "172.17.$ID.128/27")
